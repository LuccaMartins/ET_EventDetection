...
This is a fork from a repository that contains the Event Detection algorithms that I used in my BSc final project (https://github.com/LuccaMartins/CnLook_Clustering).
